...
//         },
//             "ajax":{
//                 url :"{{ route('all.centrospreparacion') }}", // json datasource
//                 type: "get",  // method  , by default get
//                 error: function(){  // error handling
//                     $(".employee-grid-error").html("");
//                     $("#centroP").append('<tbody class="employee-grid-error"><tr><th colspan="3">No hay hoteles en la base de datos</th></tr></tbody>');
//                     $("#centroP_processing").css("display","none");
