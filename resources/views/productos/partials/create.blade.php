                                    ...
                                    <div class="col-md-4">
                                        <div class="input-group">
                                            ...
                                            <div class="form-group label-floating">
                                                ...
                                                <input id="codigoProducto" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}"  maxlength="20" name="codigoProducto" required autofocus>
                                    ...
                                    <div class="col-md-4">
                                        <div class="input-group">
                                            ...
                                            <div class="form-group label-floating">
                                                ...
                                                <input id="montoPropina" type="number" step="0.01" class="form-control{{ $errors->has('montoPropina') ? ' is-invalid' : '' }}" name="montoPropina">
                                    ...
                                    <div class="col-md-4">
                                        <div class="input-group">
                                            ...
                                            <div class="form-group label-floating">
                                                ...
                                                <input id="precio" type="number" step="0.01" class="form-control{{ $errors->has('precio') ? ' is-invalid' : '' }}" name="precio" required>
        ...
        @else
            <div class="card">                    
                <div class="card-content">
                    ...
                    <div class="col-md-10">
                            <h3>Usted no tiene permiso para registrar un producto</h3>
