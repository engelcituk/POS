...
$idRestaurante = intval(preg_replace('/[^0-9]+/', '', $cadenaObtenerNumero), 10);
@endphp
<a onclick="deleteRestaurante({{$idRestaurante}})" class="btn btn-xs btn-danger"><i class="fas fa-trash-alt"></i></a>
